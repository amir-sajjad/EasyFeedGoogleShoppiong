...
const Pricing = () => {
  ...
  const getUserPlanDetails = () => {
    axioshttp.get('plan/details').then(response => {
      if (response.data.status) {
        setUserPlanDetails(response.data)
        setRecommendedPlan(response.data.variantsInShopify ? response.data.variantsInShopify : 0);
      }
  ...
  function activateCoupon () {
    ...
    const allowed = allowedPlanIds.some(elem => elem === parseInt(price));
    // console.log(parseInt(price),{allowed,allowedPlanIds})
    if (allowed === false) {
  ...
  return (
    <>
      <ThemeProvider theme={theme}>
        <>
          {loadingPage && <div className="flex justify-center m-auto"><CircularProgress style={{ color: '#008060' }} size={50} /></div>}
          {!loadingPage &&
            <>
                ...
                <Grid style={{ padding: '30px' }} xs={12} md={6}>
                  <Card sx={{ boxShadow: 1, padding: '21px', borderTop: '3px solid #008060' }} variant="outlined">
                    <div style={{ padding: '10px', display: 'flex' }}>
                      <p style={{ fontSize: '17px', fontWeight: '600' }}>Current Plan : {userPlanDetails && userPlanDetails.planName ? userPlanDetails.planName : ""}</p>
                    </div>
                    <div sx={{ padding: '10px' }} style={{ padding: '10px' }}>
                      ...
                      <Grid container>
                        ...
                        <Grid style={{ borderLeft: '1px solid rgba(0, 0, 0, 0.12)' }} xs={6} md={4}>
                          <p style={{ fontSize: '17px', fontWeight: '600', textAlign: 'center' }}>{userPlanDetails && userPlanDetails.variantsInShopify ? userPlanDetails.variantsInShopify : 0}</p>
                      ...
                      <Grid container>
                        ...
                        <Grid style={{ borderLeft: '1px solid rgba(0, 0, 0, 0.12)' }} xs={6} md={4}>
                          <p style={{ fontSize: '17px', fontWeight: '600', textAlign: 'center' }}>{userPlanDetails && userPlanDetails.variantsInApp ? userPlanDetails.variantsInApp : 0}</p>
                          <p style={{ textAlign: 'center' }}>Sku's (variants)</p>
                        </Grid>
                      </Grid>
                    </div>
                  ...
                  <Card sx={{ boxShadow: 1, padding: '8px', borderTop: '3px solid #008060' }} variant="outlined">
                    <div style={{ padding: '10px' }}>
                      <div>
                        ...
                        <div>
                          <p style={{ display: 'flex', justifyContent: 'center' }}>Total capacity: {userPlanDetails && userPlanDetails.planLimits && userPlanDetails.planLimits.skus ? userPlanDetails.planLimits.skus : 0} SKU's</p>
                          <BorderLinearProgress variant="determinate" value={userPlanDetails && userPlanDetails.skusPercentage ? userPlanDetails.skusPercentage > 100 ? 100 : userPlanDetails.skusPercentage : 0} />
                          <div style={{ display: 'flex', justifyContent: 'space-between' }}>
                            <p>Used (<b>{userPlanDetails && userPlanDetails.variantsInApp ? userPlanDetails.variantsInApp : 0}</b>)</p>
                            <p>Remaining (<b>{userPlanDetails && userPlanDetails.variantsInApp && userPlanDetails.planLimits && userPlanDetails.planLimits.skus && userPlanDetails.planLimits.skus != "Unlimited" ? (userPlanDetails.planLimits.skus - userPlanDetails.variantsInApp) < 0 ? 0 : (userPlanDetails.planLimits.skus - userPlanDetails.variantsInApp) : userPlanDetails.planLimits.skus == "Unlimited" ? userPlanDetails.planLimits.skus : 0}</b>)</p>
                          </div>
                        </div>
                      </div>
                    </div>
                    <div style={{ padding: '10px', marginTop: '10px' }}>
                      <div>
                        ...
                        <div>
                          <p style={{ display: 'flex', justifyContent: 'center' }}>Total capacity: {userPlanDetails && userPlanDetails.planLimits && userPlanDetails.planLimits.feeds ? userPlanDetails.planLimits.feeds : 0} Feeds</p>
                          <BorderLinearProgress variant="determinate" value={userPlanDetails && userPlanDetails.feedsPercentage ? userPlanDetails.feedsPercentage > 100 ? 100 : userPlanDetails.feedsPercentage : 0} />
                          <div style={{ display: 'flex', justifyContent: 'space-between' }}>
                            <p>Used (<b>{userPlanDetails && userPlanDetails.userFeedCount ? userPlanDetails.userFeedCount : 0}</b>)</p>
                            <p>Remaining (<b>{userPlanDetails && userPlanDetails.userFeedCount && userPlanDetails.planLimits && userPlanDetails.planLimits.feeds && userPlanDetails.planLimits.feeds != "Unlimited" ? (userPlanDetails.planLimits.feeds - userPlanDetails.userFeedCount) < 0 ? 0 : (userPlanDetails.planLimits.feeds - userPlanDetails.userFeedCount) : userPlanDetails.planLimits.feeds == "Unlimited" ? userPlanDetails.planLimits.feeds : 0}</b>)</p>
                          </div>
                        </div>
                      </div>
                    </div>
                      ...
                      <div className="flex justify-center flex-wrap m-auto mt-4">
                        <div className="flex">
                          ...
                          <Button
                            ...
                            className="bg-[#008060] flex item-center align-center justify-center"
                            variant="contained"
                          >
                            {isExploding && (
                              <div style={source}>
